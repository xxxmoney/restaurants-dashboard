...
export const MENU_PROMPTS = {
    ...
    [restaurantEnum.KAMYK]: `You are a restaurant menu digitizer. Convert the provided restaurant menu screenshot into a JSON representation, organized by day. The menus are per day, starting from monday to friday - date format '{0}' Monday date is: '{1}'.`
}
